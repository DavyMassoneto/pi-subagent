...
Fork `@davymassoneto/pi-subagent` 0.12.1: YAML-list frontmatter, cwd `agents/`+`subagents/` discovery, parent-only `subagent_*` facade for gentle-pi. Upstream runtime unchanged.
